if getgenv().DeepHub then warn("DeepHub.ez : Already executed!") return end
getgenv().DeepHub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | DeepHub.ez - Premium",
...
game.Players.LocalPlayer.PlayerGui.DescendantAdded:Connect(function(Descendant)
    if AutoReell == true and ReelMode == "Blatant" then
...
RunService.Heartbeat:Connect((function(delta1)
    if AutoReell == true and ReelMode == "Legit" then
        autoReelEnabled = true
        startAutoReel()
    elseif AutoReell == true or ReelMode == "Blatant" then
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/b97EhdVJjn")
        end
    })
    ...
    Tabs.Items:AddButton({
        ...
        Callback = function()
            ...
            if game.Workspace.world.chests:FindFirstChildOfClass("Part") then
                game.Workspace.world.chests:FindFirstChildOfClass("Part").CanCollide = false
                task.wait(0.2)
                game.Workspace.world.chests:FindFirstChildOfClass("Part").CFrame = game.Players.LocalPlayer.character.Torso.CFrame
                task.wait(0.2)
                fireproximityprompt(game.Workspace.world.chests:FindFirstChildOfClass("Part").ProximityPrompt)
                task.wait(1)
            end
        end
    })
    ...
    Tabs.Teleports:AddButton({
        Title = "Teleport to Anvil (Rod Crafting)",
        Description = "Teleports to the Anvil.",
        Callback = function()
            HumanoidRootPart.CFrame = CFrame.new(-3160.41016, -745.614014, 1684.24463, 0.999968767, -6.5574433e-08, 0.0079053659, 6.6269159e-08, 1, -8.76176927e-08, -0.0079053659, 8.81388402e-08, 0.999968767)
        end
    })
